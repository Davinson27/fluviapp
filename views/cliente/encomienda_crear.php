                ...
                <form action="<?= BASE_URL ?>/cliente/guardar-encomienda" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="email" name="remitente_email" class="form-control" value="<?= htmlspecialchars($usuario['email'] ?? '', ENT_QUOTES, 'UTF-8') ?>" placeholder="Para avisarte cuando llegue" required>
                        </div>
